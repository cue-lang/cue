...
const (
	...
	flagExtConfig           flagName = "extconfig"
	flagExtProfile          flagName = "extprofile"
	...
	flagListen              flagName = "listen"
	flagListenTimeout       flagName = "listen-timeout"
	...
	flagRemote              flagName = "remote"
	flagRemoteListenTimeout flagName = "remote-listen-timeout"
...
func (f flagName) Duration(cmd *Command) time.Duration {
	f.ensureAdded(cmd)
	v, _ := cmd.Flags().GetDuration(string(f))
	return v
}
