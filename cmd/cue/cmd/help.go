...
var modulesHelp = &cobra.Command{
	...
	Long: `Modules are how CUE manages dependencies.

NOTE: modules support is current experimental. To enable
the experiment, you must enable the modules experiment
by exporting this environment variable:
	CUE_EXPERIMENT=modules

A module is a collection of packages that are released, versioned, and
distributed together. Modules are downloaded from OCI container
registries.
