...
If an environment variable is unset or empty, sensible default setting is used.
	...
	CUE_CACHE_DIR
		A directory to keep files to be reused between operations.
		...
		- mod/extract for extracted module archives from registries

	CUE_CONFIG_DIR
		A directory to keep configuration and long-lived state files.
	...
	CUE_EXPERIMENT
		Comma-separated list of experiments to enable or disable, listed below:
	...
	CUE_REGISTRY
		The registries to use for downloading and publishing modules.
