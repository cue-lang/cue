...
func walkNilable[N nilableNode](node N, before func(Node) bool, after func(Node)) {
	var zero N // nil
	if node != zero {
...
func Walk(node Node, before func(Node) bool, after func(Node)) {
	...
	case *Field:
		...
		walkNilable(n.Alias, before, after)
		walkNilable(n.Value, before, after)
	...
	case *Ellipsis:
		walkNilable(n.Type, before, after)
	...
	case *SliceExpr:
		Walk(n.X, before, after)
		walkNilable(n.Low, before, after)
		walkNilable(n.High, before, after)
	...
	// Declarations
	case *ImportSpec:
		walkNilable(n.Name, before, after)
	...
	case *PostfixAlias:
		walkNilable(n.Label, before, after)
		walkNilable(n.Field, before, after)
	...
	case *ForClause:
		walkNilable(n.Key, before, after)
		Walk(n.Value, before, after)
