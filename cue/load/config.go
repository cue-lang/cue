...
func (c *Config) externalModuleDir(p importPath) (string, errors.Error) {
	// TODO get module information from resolved modules.
	return "", errors.Newf(token.NoPos, "no module information for %q", p)
}
