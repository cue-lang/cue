...
import (
	...
	"cuelang.org/go/internal/ociregistry/mod/modfile"
	"cuelang.org/go/internal/ociregistry/mod/module"

	"cuelang.org/go/internal/ociregistry"
	"cuelang.org/go/internal/ociregistry/mod/zip"
)
...
func newRegistryClient(registryHost string, cacheDir string) (*registryClient, error) {
	client, err := ociregistry.NewClient(registryHost, "cue/") // TODO configurable prefix
	if err != nil {
		return nil, err
	}
