...
const (
	...
	SelString
	// SelHiddenString represents a hidden regular field.
	SelHiddenString
...
// IsString reports whether t describes a regular field, hidden
// or not.
func (t SelectorType) IsString() bool {
	return t == SelString || t == SelHiddenString
}
