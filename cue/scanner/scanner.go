	...
	default:
		...
		case '"', '\'':
			...
			case 1:
				...
				// e.g. #""hello""#
				// but not when there are the correct number of terminating
				// hash characters.
				// e.g. ##""##
				if quote.numHash > 0 {
					// The string is surrounded by hashes, which means that
					// the single leading quote is OK (and part of the string)
					// e.g. #""hello""#
