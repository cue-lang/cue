...
func getValue(t *testing.T, c *evalConfig, body string) Value {
	t.Helper()
...
func TestError(t *testing.T) {
	...
	for _, tc := range testCases {
		runMatrix(t, tc.value, func(t *testing.T, cfg *evalConfig) {
			err := getValue(t, cfg, tc.value).Err()
...
func TestNull(t *testing.T) {
	...
	for _, tc := range testCases {
		runMatrix(t, tc.value, func(t *testing.T, cfg *evalConfig) {
			v := getValue(t, cfg, tc.value).Lookup("v")
			err := v.Null()
			checkErr(t, err, tc.err, "init")
			wantBool := err == nil
			gotBool := v.IsNull()
...
func TestBool(t *testing.T) {
	...
	for _, tc := range testCases {
		runMatrix(t, tc.value, func(t *testing.T, cfg *evalConfig) {
			got, err := getValue(t, cfg, tc.value).Bool()
...
func TestList(t *testing.T) {
	...
	for _, tc := range testCases {
		runMatrix(t, tc.value, func(t *testing.T, cfg *evalConfig) {
			l, err := getValue(t, cfg, tc.value).List()
			checkFatal(t, err, tc.err, "init")
...
func TestDefaults(t *testing.T) {
	...
	for _, tc := range testCases {
		runMatrix(t, tc.value, func(t *testing.T, cfg *evalConfig) {
			...
			v := getValue(t, cfg, "a: "+tc.value).Lookup("a")
...
func TestLen(t *testing.T) {
	...
	for _, tc := range testCases {
		runMatrix(t, tc.input, func(t *testing.T, cfg *evalConfig) {
			v := getValue(t, cfg, "a: "+tc.input).Lookup("a")
...
func TestValueLookup(t *testing.T) {
	...
	for _, tc := range testCases {
		runMatrix(t, tc.str, func(t *testing.T, cfg *evalConfig) {
			v := getValue(t, cfg, tc.config).Lookup(tc.path...)
