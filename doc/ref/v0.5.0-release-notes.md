...
Some use of these deprecated types remains:
[#1035](https://cuelang.org/issue/1035),
[#1735](https://cuelang.org/issue/1735),
[#1806](https://cuelang.org/issue/1806). These will be tidied up in later
releases as the API surface matures towards v1.0.0.
