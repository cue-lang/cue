...
// makeValueLit returns a number literal if the value looks like a valid
// integer or float, and a string literal otherwise.
func makeValueLit(s string, pos token.Pos) *ast.BasicLit {
	switch {
