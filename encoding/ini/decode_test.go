...
// dedent removes leading and trailing blank lines and shared leading whitespace
// (tabs) from a multi-line string, matching the test convention used by other
// encoding packages in this repository.
func dedent(s string) string {
	...
	// Find the minimum indentation (tabs only to match Go raw strings).
	minIndent := -1
	...
	// The split-join may produce a trailing extra newline; trim it to exactly one.
	result := sb.String()
