...
func improves(group []*nameState, trial []nameState) bool {
	distinct0, empty0 := nameStats(group, func(s *nameState) string { return s.ref.Name })
	distinct1, empty1 := nameStats(trial, func(s nameState) string { return s.name() })
...
func nameStats[S any](states []S, name func(S) string) (distinct, empty int) {
