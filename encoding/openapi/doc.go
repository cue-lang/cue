...
// whole OpenAPI document (v3.0 or v3.1) into that document; the rest of this
// package documentation concerns [GenerateV2] only.
//
...
//
//	paths: "/people": get: responses: "200": content: "application/json": schema: #: {name: string, age?: int}
//
// Writing `schema: #Person` directly (without the intervening "#") does not
// have the same meaning. The "#" marker is required, rather than interpreting
...
// there is used verbatim as the JSON Schema. A "#" definition and sibling data
// fields cannot be combined at the same schema position; doing so is an error.
//
