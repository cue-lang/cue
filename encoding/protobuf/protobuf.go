...
//	                            caution.
//
// These options are defined in cueproto/cue.proto, distributed as part of
// this module. Go code generated by protoc from definitions using them
// imports [cuelang.org/go/encoding/protobuf/cueproto]. The old import path
// cue/cue.proto remains available as a shim forwarding to the new location;
