...
#CheckRequest: {
	...
	quotas?: {[string]: #QuotaParams} @protobuf(4,map[string]QuotaParams,"(gogoproto.nullable)=false")
}
...
#CheckResponse: {
	...
	quotas?: {[string]: #QuotaResult} @protobuf(3,map[string]QuotaResult,"(gogoproto.nullable)=false")
}
