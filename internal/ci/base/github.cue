...
// dispatchTrailerPrefix is the constant that should be equivalent to the
// prefix of a commit message line added by git interpret-trailers. In a real
// commit message a one-line blob of JSON should follow immediately.
dispatchTrailerPrefix: dispatchTrailer + ": "
