...
workflowDispatch: json.#step & {
	...
	name: string
	run:  #"""
			\#(_curlGitHubAPI) -f --request POST --data-binary \#(*strconv.Quote(encjson.Marshal(#arg)) | "") https://api.github.com/repos/\#(#githubRepositoryPath)/actions/workflows/\#(#workflowID)/dispatches
			"""#
}
