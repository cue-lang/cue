			...
			steps: [
				json.#step & {
					...
					let rerunLatestWorkflow = {
						...
						\(_base.#curlGitHubAPI) https://api.github.com/repos/\(#repo)/actions/runs/$id/rerun
					...
					run: """
						...
						for j in $(\(_base.#curlGitHubAPI) https://api.github.com/repos/\(core.#githubRepositoryPath)/branches | jq -r '.[] | .name')
						do
