		...
		test: {
			...
			steps: [
				...
				json.#step & {
					...
					CGO_ENABLED=0 gh extension install actions/gh-actions-cache
					go version -m $(which gh)
					go version -m /home/runner/.local/share/gh/extensions/gh-actions-cache/gh-actions-cache
