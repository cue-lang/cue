...
workflows: trybot: _repo.bashWorkflow & {
	...
	_goTest: _repo.bashStep & {
		name: "Test"
		#run: "go test ./..."
	}

	_e2eTestSteps: [... _repo.bashStep & {
