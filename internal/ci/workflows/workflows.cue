...
import (
	"cuelang.org/go/internal/ci/workflows/gerrithub"
...
// _gerrithub is an instance of _#gerritHub, parameterised by the
...
// The repository_dispatch workflow. This is so short we haven't
// bothered to put it in a file of its own.
