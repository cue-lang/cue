...
// github.com/rogpeppe/go-internal/testscript/plugin) that provides the
// environment that the cue command expects, as implemented by
// cuelang.org/go/internal/cuetestscript and used by the cmd/cue tests
// themselves.
//
