...
type CloseInfo struct {
	...
	*closeContext // new implementation

	// IsClosed is true if this conjunct represents a single level of closing
	// as indicated by the closed builtin.
	IsClosed bool

	// IsEmbed indicates whether this conjunct was inserted because of an
	// embedding.  This flag is sticky and will be set for conjuncts created
	// from fields defined by this conjunct.
	// NOTE: only used when using closeContext.
	FromEmbed bool

	// IsEmbed indicates whether this conjunct was inserted because of a
	// definition. This flag is sticky and will be set for conjuncts created
	// from fields defined by this conjunct.
	// NOTE: only used when using closeContext.
	FromDef bool
