...
const (
	...
	// its conjuncts need to be processed to fined out. This happens when an arc
	// is provisionally added as part of a comprehension, but when this
	// comprehension has not yet yielded any results.
	ArcPending

	// ArcNonExisting indicates that this arc is not present and, unlike
...
// exists reports whether an arc is a constraint or member arc.
