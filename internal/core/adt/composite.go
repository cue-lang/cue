...
type Vertex struct {
	...
	// notAddressable indicates that this Vertex is being computed within a
...
func (v *Vertex) MayAttach() bool {
	return !v.Label.IsLet() && !v.notAddressable
}
...
func (v *Vertex) GetArc(c *OpContext, f Feature, t ArcType) (arc *Vertex, isNew bool) {
	...
	arc = &Vertex{
		...
		notAddressable: v.notAddressable || v.Label.IsLet(),
	}
