...
type Vertex struct {
	...
	hasAllConjuncts bool // conjuncts of ancestors have been processed.
...
func (v *Vertex) HasAllConjuncts() bool {
	return v.status == Conjuncts
}
...
func (v *Vertex) addConjunctUnchecked(c Conjunct) {
	...
	if n := v.state; n != nil {
		...
		n.notifyConjunct(c) // XXX: can this call be removed?
	}
}
