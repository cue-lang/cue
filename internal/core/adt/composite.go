...
// Constraint converts a given AST constraint token to the corresponding
// ArcType.
...
// TokenString reports the field suffix for the given ArcType if it is a
// constraint or the empty string otherwise.
func (a ArcType) TokenString() string {
	switch a {
	case ArcOptional:
		return "?"
	}
