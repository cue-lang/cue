...
// # Abstract Types
//
// The following types describe a place where a value may be used:
//
//	Decl       a value that can be used as a StructLit element.
//	Elem       a value that can be used as a ListLit element.
...
// references with the aid of an Environment. At compile time, each
