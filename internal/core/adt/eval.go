...
// validateValue is hoisted to allow sharing between the new and old
// implementation.
...
func (n *nodeContext) clone() *nodeContext {
	...
	// Do not clone other disjunction-related slices.
...
func (c *OpContext) newNodeContext(node *Vertex) *nodeContext {
	...
	return &nodeContext{nodeContextState: nodeContextState{
		ctx:  c,
		node: node,
		kind: TopKind,
	}}
