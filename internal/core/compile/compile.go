...
type compiler struct {
	...
	// via a LabelReference. This is used to set HasLabel on BulkOptionalField,
...
func (c *compiler) decl(d ast.Decl) adt.Decl {
	...
	case *ast.Field:
		...
		hasLabel := c.refersToLabelReference
		c.refersToLabelReference = savedLabelRef || hasLabel
