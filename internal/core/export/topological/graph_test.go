...
func buildGraphFromPermutation(permutation [][]adt.Feature) *topological.Graph {
	builder := topological.NewGraphBuilder()
...
func testAllPermutations(t *testing.T, indexer adt.StringIndexer, inputs [][]string, fun func(*testing.T, [][]adt.Feature, *topological.Graph)) {
