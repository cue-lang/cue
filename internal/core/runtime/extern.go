...
type Interpreter interface {
	...
	// Type returns the string to be used in the file-level @extern attribute.
	Type() string
}
...
type Compiler interface {
	...
	// funcName is the name of the field, or altName in @extern(name=altName) if
	// it is defined in a.
	// The fields in the attributes are implementation specific.
...
// attribute in f and reports position in f.Decls right after the package
// declaration. It's an error if more than one @extern attribute is found.
// decls == nil signals that this file should be skipped.
...
// initCompiler gets the runtime for kind, if applicable,
...
// Collect all *ast.Fields with extern attributes into d.fields.
