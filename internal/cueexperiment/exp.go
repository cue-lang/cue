...
var Flags struct {
	...
	// CmdTaskByID allows declaring tasks via the "$id" and legacy "kind" string fields
	// without importing and referencing one of the tool packages.
	CmdTaskByID bool `envflag:"default:true"`
