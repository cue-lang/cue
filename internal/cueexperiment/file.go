...
// IsAvailable returns true if the experiment exists and can be used
// for the given version.
func IsAvailable(experiment, version string) bool {
...
func GetActiveExperiments(origVersion, targetVersion string) []string {
...
// GetUpgradeExperiments returns all experiments that are stable
