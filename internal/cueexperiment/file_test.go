...
type testFile struct {
	...
	Exp10_R14 bool `experiment:"since:v0.10.0,rejected:v0.14.0"`
	Exp11_R13 bool `experiment:"since:v0.11.0,rejected:v0.13.0"`

	Exp13_A15 bool `experiment:"since:v0.13.0,accepted:v0.15.0"`

	Exp14 bool `experiment:"since:v0.14.0"`
	Exp15 bool `experiment:"since:v0.15.0"`
}
...
func TestCanApplyExperimentFix(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			version:    "v0.14.0",
			target:     "v0.14.0",
			wantErr:    "experiment \"exp15\" requires version v0.15.0 or later, got v0.14.0",
		},
		{
		...
		},
		{
			...
			version:    "v0.15.0",
			target:     "v0.15.0",
			wantErr:    `experiment "exp13_a15" is already accepted as of version v0.15.0 - cannot apply fix`,
		},
		{
			name:       "rejected",
			...
			version:    "v0.11.0",
			target:     "v0.13.0",
			wantErr:    `experiment "exp11_r13" is rejected in version v0.13.0`,
		},
		{
