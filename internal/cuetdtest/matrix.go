...
func (m *M) BrokenInV2(t testing.TB) {
	if m.version == internal.DefaultVersion && m.version != internal.DevVersion {
		t.Skip("Skipping because test is broken in old evaluator version")
	}
}
