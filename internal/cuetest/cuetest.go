...
// NewTD creates a new table-driven test using the CUE testing defaults.
func NewTD[TC any](t *testing.T, table []TC) *tdtest.Set[TC] {
	return tdtest.New(t, table, &tdtest.Config{Update: UpdateGoldenFiles})
}
