...
"+Inf": 2`,
	...
	},
	{
		...
		`"float32_maxuint64+1": float & 18446744073709551616`,
	},
	...
	},
	{
		...
		`"float64_maxuint64+1": float & 18446744073709551616`,
	},
...
e: []
`,
		// TODO(mvdan): keep the separated opening/closing tokens once go-yaml.v3 exposes end positions.
		`a: {}
b: {}
c: 1
d: []
...
`,
	...
	// Floating comments.
	// TODO(mvdan): empty lines separating comments should stay in place.
...
func newDecoder(t *testing.T, data string) *yaml.Decoder {
	dec := yaml.NewDecoder("test.yaml", []byte(data))
	return dec
}
