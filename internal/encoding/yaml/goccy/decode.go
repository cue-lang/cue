...
// that goccy lexes as strings but that this package resolves as
// numbers, such as integers beyond 64 bits, infinities with unusual
// casing, or exponents without a decimal point, are decoded as numbers;
// see [numberKind].
