	...
	testCases := []struct {
		...
		out: &FileInfo{
			File: &build.File{
				...
				Interpretation: "jsonschema",
				Form:           build.Schema,
				BoolTags:       map[string]bool{"strict": false, "strictFeatures": false, "strictKeywords": false},
			},
			Definitions:  true,
			Data:         true,
			Optional:     true,
...
func TestParseArgs(t *testing.T) {
	testCases := []struct {
		...
		in: "data: foo.cue",
		out: []*build.File{
			{Filename: "foo.cue", Encoding: build.CUE, Form: "data"},
		},
	}, {
		...
		out: []*build.File{
			{
				...
				Interpretation: "jsonschema",
				Form:           build.Schema,
				BoolTags:       map[string]bool{"strict": true, "strictFeatures": true, "strictKeywords": true},
			},
		},
	}, {
