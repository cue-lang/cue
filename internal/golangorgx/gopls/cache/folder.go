...
// Create a new workspace folder. The fetchFolderOptions func is
// called in order to obtain the options for this folder.
...
// Update this folder's options, by using the provided func.
...
// For this workspace folder, add file watching glob patterns to the
// patterns map, and return whether or not this folder requires
