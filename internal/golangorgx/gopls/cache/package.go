...
type packageOrModule interface {
	...
	// Encloses tests for whether the file is enclosed by the package
	// or module.
...
type Package struct {
	...
	module *Module
	// importPath is always normalised and canonical. It will always
	// have a non-empty major version
	//
	// immutable: set once at construction
