...
// within this workspace. The name is entirely decorative and does not
// have any semantics attached to it. This method is idempotent: if
// the workspace already includes a workspace folder at dir, then this
// method is a noop and returns nil.
