...
// Enqueue adds the fun to the end of the queue. It is
// non-blocking. The fun will be run in its own go-routine, and will
// not run until the previous item in the queue has finished running.
