...
// will be embedded within the return [*ast.File] rather than only its
// elements being included in the returned File. This ensures that
// position information of the StructLit's braces are not lost.
