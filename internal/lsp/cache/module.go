...
// and loads them, returing the packages. To do this, the modfile
// itself must be successfully loaded. The only non-nil error this
// method returns is if the modfile cannot be loaded.
