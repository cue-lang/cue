...
//	x₂: y₂: 7
//
// Here, the outermost lexical scope has two bindings for x, each
// having a distinct lexical scope. But both of those scopes share a
...
// shared "navigable scope". Thus in this example, the outermost
// lexical scope has two bindings for x; their distinct scopes have
// one binding each for their respective y fields; the lexical scopes
// for the two x bindings share a "navigable scope", and their
// individual bindings for y both appear grouped together within that
