...
// TestReadCUENonCUECached shows bad behaviour: unlike a CUE file's,
// the parse of a JSON or YAML file is never cached, so repeated
// reads return distinct ASTs, and the returned config is invalid.
