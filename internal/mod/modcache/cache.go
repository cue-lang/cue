...
import (
	...
	"cuelang.org/go/internal/mod/internal/robustio"
...
func (c *cache) cacheDir(ctx context.Context, mpath string) (string, error) {
	mdir, err := module.EscapePath(mpath)
	if err != nil {
		return "", err
	}
	return filepath.Join(c.dir, "cache/download", mdir, "/@v"), nil
}
...
// writeDiskGoMod writes a cue.mod/module.cue cache entry.
