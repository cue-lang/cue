...
// ParseCUERegistry parses s into a Resolver. s is composed of a possibly empty
// list of module prefix to registry location mappings, and optional single
// catch-all registry location. e.g.
//
//	my.org/foo=myregistry.org/cuemodules,registry.cuelang.org,test.example.com,mylocalhost+insecure
//
