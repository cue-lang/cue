...
// ImportPathParts holds the various components of an
// import path.
type ImportPathParts struct {
	// Path holds the base package/directory path.
	Path string
...
func (parts ImportPathParts) Canonical() string {
...
func (parts ImportPathParts) Unqualified() string {
	parts.Qualifier = ""
	parts.ExplicitQualifier = false
	return parts.String()
}

func (parts ImportPathParts) String() string {
...
func ParseImportPath(p string) ImportPathParts {
	var parts ImportPathParts
