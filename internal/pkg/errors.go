...
// setCallError records b as the call result, dropping the call-site path it
// reports about itself. Call errors are re-wrapped by the call's own context
// error, which already locates them; a path here would duplicate it.
