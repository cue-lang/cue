...
// newlines even if they extend past the line width - a lone trailing
...
// sits inside a [docGroup], that group can choose flat-mode and the
// flat branch is taken; outside any group, the cell is rendered in
// modeBreak and the broken branch is taken.
