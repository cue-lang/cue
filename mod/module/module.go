...
// TODO move error types into error.go
...
// MustParseVersion is like [ParseVersion] except that it
// panics on error.
...
// MustNewVersion is like [NewVersion] except that it panics
// on error.
...
// Sort sorts the list by module path, breaking ties by comparing versions.
// The versions are interpreted as semantic versions (using semver.Compare)
