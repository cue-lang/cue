...
// ParseCIDRResult holds the parsed components of a CIDR notation string.
type ParseCIDRResult struct {
...
func ParseCIDR(s string) (*ParseCIDRResult, error) {
