...
//		//
//		// Note: Sub-tasks (like exec.Run) cannot currently be executed during
//		// request handling. The response must be computed from the request data
//		// using pure CUE expressions and builtin functions.
//		response: {
