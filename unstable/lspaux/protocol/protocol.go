...
type FileCoordinate struct {
	Path       string // slash-separated path relative to the git repo root
...
// EvalResultMsg is sent in response to an EvalRequestMsg.  Exactly
// one result is sent per request, matched by RequestID.
